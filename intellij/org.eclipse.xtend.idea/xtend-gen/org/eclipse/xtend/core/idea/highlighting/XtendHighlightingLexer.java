...
public class XtendHighlightingLexer extends LexerBase {
  ...
  private final static Set<String> TOKEN_TYPE_NAMES_CONTAINING_GUILLEMETS = Collections.<String>unmodifiableSet(CollectionLiterals.<String>newHashSet("RULE_RICH_TEXT", "RULE_RICH_TEXT_START", "RULE_RICH_TEXT_END", "RULE_RICH_TEXT_INBETWEEN", "RULE_COMMENT_RICH_TEXT_INBETWEEN", "RULE_COMMENT_RICH_TEXT_END"));
